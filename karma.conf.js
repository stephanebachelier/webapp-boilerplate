...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'app/bower_components/backbone.babysitter/lib/amd/backbone.babysitter.js', included: false},
      {pattern: 'app/bower_components/backbone.wreqr/lib/amd/backbone.wreqr.js', included: false},
